...
7. 对于搭配的西文字体，推荐 [Ysabeau](https://github.com/CatharsisFonts/Ysabeau) 系列字体。另有采用 [字体合并补全工具](https://github.com/nowar-fonts/Warcraft-Font-Merger) 将 Ysabeau Office 与霞鹜文楷轻便版合并而成的 [LXGW Bright](https://github.com/lxgw/LxgwBright) 字体，提供 TTF 和 OTF 两种格式。
