...
> - 繁體中文舊字形版 [霞鶩文楷 TC / LXGW WenKai TC](https://github.com/lxgw/LxgwWenkaiTC/) 正在製作中，目前正在參考 [傳承字形檢校表](https://github.com/ichitenfont/inheritedglyphs) 進行字形調整，但並不追求完全遵循之。
