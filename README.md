...
> - 以 Bold 字重为基础的 [霞鹜文楷屏幕阅读版 / LXGW WenKai Screen](https://github.com/lxgw/LxgwWenKai-Screen)，PC 和 Android 手机屏幕阅读更加舒适，无需特别切换到粗体模式。**另有字重更粗且经过手工调整的 [霞鹜臻楷 / LXGW ZhenKai](https://github.com/lxgw/LxgwZhenKai)，加粗的同时减少笔画黏连。目前正处于测试阶段，最终将做完 GB 2312 及《通用规范汉字表》。**
