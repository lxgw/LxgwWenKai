...
- **2021.10.01** 增补完 CJK 统一汉字基本区，版本号 1.100。此后分为完整版（本项目）和 [轻便版](https://github.com/lxgw/LxgwWenKai-Lite)（适用于开发者嵌入 APP），新增 [屏幕阅读版](https://github.com/lxgw/LxgwWenKai-Screen)（适用与 PC 与 Android 设备屏幕阅读）。
