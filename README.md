...
- [x] 补完 CJK 统一汉字基本区 20992 个汉字、扩展 A 区 6592 个汉字 *（目前完整版有 4 千多个字形由 zi2zi 深度学习生成，字形较粗糙）* ；
- [x] 补全 Unicode 迄今为止收录的所有谚文音节，共 11172 个 *（做得比较拙劣。轻便版不包含）*。
...
5. 该字体的更多版本 *（可能会随时变动）*
   ...
   6. 日本語版が必要な場合は、元のフォント[クレー One](https://github.com/fontworks-fonts/Klee) をそのまま使用してください。
