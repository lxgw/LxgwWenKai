...
>   <!--   - [霞鹜规楷 / LXGW GuiKai](https://github.com/lxgw/LxgwGuiKai)：在文楷基础上进一步调整字形和笔形，符合 G 源字形规范。包含《通用规范汉字表》8105 个汉字。 -->
...
5. 该字体的更多版本 *（可能会随时变动）*
   ...
   <!-- 2. [霞鹜规楷 / LXGW GuiKai](https://github.com/lxgw/LxgwGuiKai)：在文楷基础上进一步调整字形和笔形，符合 G 源字形规范。包含《通用规范汉字表》8105 个汉字。-->
